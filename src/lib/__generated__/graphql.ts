...
export type GetPresignedS3UrlsQueryVariables = Exact<{
  keys: Array<Scalars['String']['input']> | Scalars['String']['input'];
}>;


export type GetPresignedS3UrlsQuery = { __typename?: 'Query', getPresignedS3Urls: Array<string> };
